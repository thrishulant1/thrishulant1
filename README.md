...
- Implemented a GitHub Actions CI pipeline to run the test suite and generate reports on every push and pull request
- Root-caused a production-impacting API auth bug and restored passing tests
